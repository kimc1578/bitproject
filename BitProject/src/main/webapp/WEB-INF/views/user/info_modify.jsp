		...
		<div class="bm-container">
			...
			<div class="col-md-12">
				<div class="page-header" align="center">
					<h1 class="header">Modify Information</h1>
				</div>
          ...
          <label class="col-sm-3 control-label" for="inputEmail">e-mail</label>-->
						<div class="col-sm-9">
							<form action="/user/modifyOk" method="post" id="modifrm">
					...
					<div class="form-group">
						<div class="col-sm-9 ">
							<button class="btn btn-primary modiyinfo_btn" type="button">OK</button>
							<button class="btn btn-danger modicansel_bnt" type="button">Cansel</button>
						</div>
					</div>
				</div>
			</div>
