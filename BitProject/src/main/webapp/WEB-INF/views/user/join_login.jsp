...
body .container .tabs .tab.active , body .container .tabs .tab:hover  {
  color: #5385c1;
}
...
<section class="container">
		    <article class="half">
			        <h1>Zoom</h1>
			        <div class="tabs">
				            <span class="tab signin login active">Sign in</span>
<!-- 				            <span class="tab signin login active"><a href="">Sign in</a></span> -->
				            <span class="tab signup join">Join in</span>
<!-- 				            <span class="tab signup join"><a href="">Join in</a></span> -->
			        </div>
			        <div class="content">
				            <div class="signin-cont cont loginfrm">
					                <form action="/user/loginOk" method="post" >
						                    <input type="id" name="userid" id="id" class="inpt" required="required" placeholder="Your ID">
    				        ...
    				        <div class="signup-cont cont joinfrm">
                <form action="/user/joinOk" method="post" >
                                            <input type="text" name="userid" class="inpt" required="required" placeholder="Your ID">
						                    <label for="id">Your ID</label>
						                    <input type="name" name="username" id="name" class="inpt" required="required" placeholder="Your name">
						                    <label for="name">Your name</label>
                                            <input type="email" name="email" id="e-mail" class="inpt" required="required" placeholder="Your email">
						                    <label for="email">Your email</label>
						                    <input type="password" name="userpw" id="pw" class="inpt" required="required" placeholder="Your password">
                						    <label for="password">Your password</label>
                                            <input type="password"  id="ckpw" class="inpt" required="required" placeholder="Check your password">
                						    <label for="password">Check your password</label>
						                    <div class="submit-wrap">
							                        <input type="submit" value="Join in" class="submit">
