		...
		<div class="bm-container">
			...
			<div class="col-md-12">
				<div class="page-header" align="center">
					<h1 class="header">Member Information</h1>
				</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input class="form-control" id="ID" type="text" name="ID"
								value="${userinfovo.userid}" readonly>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input class="form-control" id="inputName" type="text"
								value="${userinfovo.username}" readonly>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input class="form-control" id="inputEmail" type="email"
								name="email" value="${userinfovo.email }" readonly>
						</div>
					</div>
					<!--
        <div class="form-group">
          <div class="col-sm-9 ">
            ...
            <button class="btn btn-danger" type="submit">Cansel</button>
          </div>
        </div>-->
				</div>
			</div>
