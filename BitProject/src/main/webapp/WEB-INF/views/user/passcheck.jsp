	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		...
		<article class="container">
			...
			<div class="search-group">
				<form action="/ig_search" class="form-horizontal searchfrm">
		...
		<div class="bm-container">
			...
			<div class="col-md-12" align="center">
				<div class="page-header">
					<h2>Reconfirm Password</h2>
				</div>

				<div class="form-group">

					<div class="col-sm-12">
						<form action="/user/passcheckOk" method="post" id="passcheckfrm">
							<input class="form-control" id="inputPassword" name="userpw"
								type="password" placeholder="Password" align="center">
						</form>
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-12 text-center">
						<button class="button button1 pass_btn" type="button">OK</button>
					</div>
				</div>
