		...
		<article class="container">
			...
			<div class="search-group">
				<form class="form-horizontal searchfrm" action="/ig_search">
					<input class="search-area" id="search" name="q" value="${q}" type="search">
				</form>
	...
	<div class="space">
		<div class="bm-container">
			...
			<c:choose>
				...
				<c:otherwise>
					<c:forEach items="${bk_list}" var="bk_vo">
               <div class="row">

                  <div class="image">
                     <a href="#"> <img class="img-responsive" src="${bk_vo.image}"
                        alt="">
                     </a>
                  </div>

                  <div class="info">
                     <div class="title"><a href="search_deatil?detailNo=${ bk_vo.detailNo}">${bk_vo.title}</a></div>
                     <div class="subtitle">${bk_vo.subtitle}</div>
                     <div class="publisher">${bk_vo.publisher}</div>
                     <div class="writer">${bk_vo.writer}</div>
                     <div class="price">${bk_vo.price}</div>
                  </div>

               </div>
            </c:forEach>
			 <div class="more_area">
               <a class="more" href="/search?q=${q}" >more</a>
               <div class="ag-right-area">
                  <i class="fa fa-angle-right"
                     style="font-size: 16px; color: #5385c1; float: right;"></i>
               </div>
            </div>
	     ...
	     <c:forEach items="${weblist}" var="webvo">
               <div class="web-row">
                  <div class="web-info">
                     <div class="title">${webvo.title }</div>
                     <div class="details">${webvo.description }</div>
                     <a class="site" href="${webvo.link }">${webvo.link }</a>
                  </div>
               </div>
            </c:forEach>

				 <div class="more_area">
               <a class="more" href="/search_webdocument?q=${q}" >more</a>
               <div class="ag-right-area">
                  <i class="fa fa-angle-right"
                     style="font-size: 16px; color: #5385c1; float: right;"></i>
               </div>
